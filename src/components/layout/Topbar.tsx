    ...
    <header className="h-14 flex items-center gap-3 border-b border-border bg-card/80 backdrop-blur-md px-3 shrink-0 print:hidden sticky top-0 z-30">
      ...
      <div className="flex-1 flex justify-center max-w-xl mx-auto">
        <div className="relative w-full max-w-md">
          ...
          <Input
            placeholder="Search samples, methods, equipment…"
            className="pl-8 h-8 bg-muted/50 border-transparent focus-visible:bg-card focus-visible:border-border text-sm"
          />
          <kbd className="hidden md:inline-flex absolute right-2 top-1/2 -translate-y-1/2 h-5 select-none items-center gap-1 rounded border border-border bg-muted px-1.5 font-mono text-[10px] text-muted-foreground">
            ⌘K
          </kbd>
        </div>
      </div>
